...
> To explore different types of normalization techniques 
...
The main objective of this assignment is to implement below mentioned normalization technique on MNIST data and study their characteristics. 
 ...
 - Network with L1 and batch normalization
 - The model.py contains these model which takes an argument to decide which normalization to use 

  
The **summary** of the three different models are shown below

  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/model_summary_bn.png?raw=true" width =500>
    <br>
    <em style="color: grey">Figure 1.b : Model Summary BN with L1 loss</em>
  </p> 
  
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/model_summary_ln.png?raw=true" width =500>
    <br>
    <em style="color: grey">Figure 1.c : Model Summary Layer norm</em>
  </p> 
  
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/model_summary_gn.png?raw=true" width =500>
    <br>
...
Misclassified images during validation for all the three models are shown below
  ...
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/Misclassified_bn.png?raw=true" width =1000>
    <br>
   ...
   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/Misclassified_ln.png?raw=true" width =1000>
    <br>
   ...
   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/Misclassified_gn.png?raw=true" width =1000>
    <br>
...
The test and validation loss and accuracy are shown below
 ...
 <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/types_of_normalization/blob/main/Images/loss_accurarcy_plot.png?raw=true" width =700>
    <br>
